package com.ab.view.roundimageview;
...
/**
 * Created by paulxu on 15/10/30.
 */

public class NBCircleImageView extends ImageView {
    ...
    public NBCircleImageView(Context context) {
        super(context);

        init();
    }

    public NBCircleImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NBCircleImageView(Context context, AttributeSet attrs, int defStyle) {

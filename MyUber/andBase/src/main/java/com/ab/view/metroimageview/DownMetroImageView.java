package com.ab.view.metroimageview;
...
/**
 * 点击下沉浮动的MetroImageView
 */
public class DownMetroImageView extends ImageView {
    ...
    public DownMetroImageView(Context context) {
        super(context);
        camera = new Camera();
    }

    public DownMetroImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                RolateX = vWidth / 2 - X;
                RolateY = vHeight / 2 - Y;
                XbigY = Math.abs(RolateX) > Math.abs(RolateY);

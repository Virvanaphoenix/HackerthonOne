...
public class AbShortCutUtils {
     ...
     */
    public static void addShortCut(Context context, String showName, Class<?> className, int resourceId) {
        if (hasShortcut(context, showName)) {
            return;
        }
...
//		}
        ...
        intent.addCategory(Intent.CATEGORY_LAUNCHER).setClassName(context.getApplicationContext(), className.getName());
